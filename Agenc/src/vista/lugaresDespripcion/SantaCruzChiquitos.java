...
import javax.swing.*;
import java.awt.*;
public class SantaCruzChiquitos extends JFrame{
    JPanel panel = new JPanel();

    public SantaCruzChiquitos() {
        setTitle("");
    ...
    private void colocarEtiqueta() {
        ...
        JLabel etiqueta2 = new JLabel("San Jose de Chiquitos", SwingConstants.CENTER);
        panel.add(etiqueta2);
        etiqueta2.setBounds(280, 80, 500, 50);
        etiqueta2.setForeground(Color.white);
        etiqueta2.setFont(new Font("arial", Font.BOLD, 20));
        //imagen
        ImageIcon imagen1 = new ImageIcon(getClass().getResource("/vista/LugaresTuristicos/Santa Cruz/San Jose de Chiquitos/info1.jpeg"));
        ...
        panel.add(foto1);
        //imagen1
        ImageIcon imagen2 = new ImageIcon(getClass().getResource("/vista/LugaresTuristicos/Santa Cruz/San Jose de Chiquitos/info2.jpeg"));
        ...
        panel.add(foto2);
        //imagen2
        ImageIcon imagen3 = new ImageIcon(getClass().getResource("/vista/LugaresTuristicos/Santa Cruz/San Jose de Chiquitos/info3.jpg"));
