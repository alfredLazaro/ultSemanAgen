...
public class ImpresorObjetosPrueba {
    ...
    public ImpresorObjetosPrueba(){
        ...
        */
        /*
        Transporte transp=new Transporte(0, "Oruro", "caballo");
        ...
        */
        ...
        /*
        PaqueteTuristico pa=buscarPac(477); // error en qui nose por que
        ...
        */
        ...
        //por alguna razon se lleno de 80 paq//ya se corrigio
        /////////////////
        ...
        //agregPac("Cristo de la Concordia", "Bus Turistico", "Tropical Chicken","Huper Hotel Boutique",50);
        */
        ///////////////////////////////////////////////////////////////////////////////////////////////////////
        //EmpresaPasaje
        /*
        ArrayList<EmpresaPasaje> list=getEmpres();
        for(EmpresaPasaje e:list){
            System.out.println("nombre: " +e.getNombreEmpresa());
            System.out.println("nroDepart; "+ e.getDepartamentosHabiles().size());
            
            for(DepartamentoDestino d:e.getDepartamentosHabiles()){
                
                System.out.println("depart: "+ d.getNombreDepartament());
            }
            System.out.println("");
        }
        */
    ...
    public ArrayList<EmpresaPasaje> getEmpres(){
        ArrayList<EmpresaPasaje> emprs=new ArrayList<EmpresaPasaje>();
        emprs=XMLEmpresaPasaje.listaEmpresas();
        return emprs;
    }
}
