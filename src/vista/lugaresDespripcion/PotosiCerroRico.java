...
public class PotosiCerroRico extends JFrame{
    ...
    private void integrInfo(){
        ...
        lblDescrp=new JLabel("<html><p>Su ubicacion se encuentra en la provincia de Daniel Campos en el departamento de Potosi dentro de la region altiplanica de la Cordillera de los Andes, considerada como  una inmensa planicie en forma de desierto de sal situada a más de 3.600 metros sobre el nivel del mar.<p><html>"
